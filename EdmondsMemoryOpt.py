...
#     print ('No Infected nodes. The Source is '+str(random_node)+'\n')
#     return None, None
#   else: 
#     print ('Number of infected: '+str(len(infected_nodes))+'\n')
#   return infected_nodes, getInfectedSubgraph(graph, infected_nodes)
...
# graph.add_edge('200','1000',act_prob=0.9)
...
while True:
    ...
    print ('N',n)
    infected_nodes = independent_cascade(graph, random_sources, 3, option=True, n=n)
    print(len(infected_nodes))
    if 100 <= len(infected_nodes) <= 250:
        break
...
#             roots.append(node)
#     return roots
# for sub in infected_subgraphs:
#     br = maximum_branching(sub, 'act_prob')
#     print(find_roots(br))
# random_node = choice(g.nodes())
# print ('Random node '+random_node)
# infected_nodes, infected_subgraph = getInfectedOfCascadeByNode(pathname_graph, 4, random_node, False)

# print (len(infected_nodes))
# branch = maximum_spanning_arborescence(infected_subgraph, attr='act_prob')
...
#         source = False
#     if source:
#         print ('Source is '+node)


# g = nx.DiGraph()
# g = nx.DiGraph()
# g.add_edge(0, 1, act_prob=0.5)
# g.add_edge(0, 2, act_prob=0.8)
# g.add_edge(1, 2, act_prob=0.3)
# g.add_edge(1, 3, act_prob=0.4)
# g.add_edge(2, 4, act_prob=0.6)
# g.add_edge(3, 4, act_prob=0.2)
# g.add_edge(4, 0, act_prob=0.7)
# g.add_edge('A','B',act_prob=3)
# g.add_edge('A','C',act_prob=1)
# g.add_edge('C','D',act_prob=1)
# g.add_edge('D','C',act_prob=100)

# g.add_edge(3, 4, act_prob=0.6)
# g.add_edge(3, 1, act_prob=0.7)
# g.add_edge(4, 2, act_prob=0.8)
# g.add_edge(1, 2, act_prob=0.2)
# g.add_edge(1, 0, act_prob=0.9)
# g.add_edge(2, 0, act_prob=0.8)
# g.add_edge(0, 3, act_prob=0.7)
# g.add_edge(0, 1, act_prob=0.6)
# g.add_edge(0, 2, act_prob=0.7)
# g.add_edge(7, 8, act_prob=0.7)
# g.add_edge(8, 9, act_prob=0.7)
# g.add_edge(9, 10, act_prob=0.7)
# with open('subgraph','rb') as infile:
#     g = pickle.load(infile)
# branching, _ = maximum_spanning_arborescence(g, 'act_prob')
# print (branching.edges())
# print (sources)
# pathname_graph = 'graphs/random_graph101n500m'

# graph = readDirectWeightedGraph(pathname_graph)

# branching, _ = maximum_branching(graph, 'act_prob')
